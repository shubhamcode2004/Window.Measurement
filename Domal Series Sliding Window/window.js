...
function addRow() {
  ...
  switch (operation) {
    case "2T = 2G":
      ...
      glass_height = handle_interlock - 4.5;
      mesh_length = 0;
      mesh_height = 0;
      no_glass = 2;
      no_mesh = 0;
    ...
    case "3T = 2G+1M":
      ...
      glass_length = top_bottom - 4.5;
      glass_height = handle_interlock - 4.5;
      mesh_length = top_bottom - 2.8;
      mesh_height = handle_interlock - 2.8;
      no_glass = 2;
      no_mesh = 1;
